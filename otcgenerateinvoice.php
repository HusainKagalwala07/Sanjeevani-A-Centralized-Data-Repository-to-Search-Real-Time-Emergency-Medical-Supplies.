    ...
    <div id="wrapper">
      ...
      <div id="content-wrapper">
		...
		<label>Add Patient</label>
            ...
            $addnewproduct = mysqli_query($link,"SELECT entitydetails.name,entitydetails.email,entitydetails.contact,patient.date, entitydetails.address,entitydetails.edid from entitydetails join patient on entitydetails.edid=patient.edidpatient where fktype=4");
		...
		<button onclick="myFunction()" type ="submit" name="verify" value="verify" class="btn btn-info">Verify</button>
            <a class="btn btn-info" href="otcaddproducts.php" target="_parent">Generate Invoice</a>
        ...
        if(isset($_POST["verify"]))
        {
            ...
            $sdate = htmlentities($_POST['sdate']);
             $sql = "insert into prescription_parent values('','$edid','$patientid','$sdate')";
