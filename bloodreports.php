      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="row">
           ...
           <?php 
//index.php
$connect1 = mysqli_connect("localhost", "root", "", "project-sanjeevani");
$query1 = " SELECT entitydetails.name as m, COUNT(bloodinventory.hospid) as s FROM entitydetails LEFT JOIN bloodinventory ON entitydetails.edid = bloodinventory.hospid where entitydetails.fktype='1' GROUP BY m ";
...
?>
   ...
   <h3 align="center">Monthly Blood Unit Graph</h3>   
   <br /><br />
   <div id="chart"></div>
  </div>
