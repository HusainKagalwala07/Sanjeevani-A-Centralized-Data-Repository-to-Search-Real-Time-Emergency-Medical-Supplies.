  ...
  <body id="page-top">
    ...
    <div id="wrapper">
     ...
     <ul class="sidebar navbar-nav">
		...
		<li class="nav-item active">
          <a class="nav-link" target="_blank" href="https://jumpch.at/c/<?php echo $contact; ?>">
          ...
          <div class="row">
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-primary o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">Patients Record</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="patientrecords.php">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-success o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" target="_blank" href="https://jumpch.at/c/<?php echo $contact; ?>">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-danger o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">Prescribe Drugs</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="prescribedrug.php">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
