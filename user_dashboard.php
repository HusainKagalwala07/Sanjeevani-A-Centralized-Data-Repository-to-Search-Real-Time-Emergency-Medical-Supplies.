            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-primary o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">Nearby Blood Banks</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="findnearbyhospital_user.php">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-warning o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">Nearby Pharmacies</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="findnearbypharmacy.php">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-success o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">Calling Facility</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="callingdoctor.php">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
			...
			<div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-dark o-hidden h-100">
                <div class="card-body">
                  ...
                  <div class="mr-5">View Previous Prescription / Invoices</div>
                </div>
                <a class="card-footer text-white clearfix small z-1" href="viewprescriptions.php">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
