    ...
    <ul class="sidebar navbar-nav">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
		  ...
		  <?php
		  $edid= $_GET['edid'];
		  //$queryfetch="SELECT * from entitydetails WHERE email = '$credentials'";
		  ...
		  $res=mysqli_query($link,"select bloodgroup.name as bgroup, count(bloodinventory.grpid) as qty from bloodgroup join bloodinventory on bloodgroup.grpid=bloodinventory.grpid join entitydetails on entitydetails.edid=bloodinventory.hospid where entitydetails.edid=$edid and bloodgroup.grpid='$bloodgroup'");
		  ...
		  {
	      echo "<tr>";
		  echo "<td>";echo $row["bgroup"];echo "</td>";
