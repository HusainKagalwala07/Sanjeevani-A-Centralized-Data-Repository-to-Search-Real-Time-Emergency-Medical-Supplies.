...
entitydetails.pincode, entitydetails.contact, entitydetails.latitude, entitydetails.longitude, concat('http://localhost/Project-Sanjeevani/viewstock_user.php?edid=', entitydetails.edid, '&bloodgroup=', '$blood_type') as URL from entitydetails WHERE fktype='1' and 
