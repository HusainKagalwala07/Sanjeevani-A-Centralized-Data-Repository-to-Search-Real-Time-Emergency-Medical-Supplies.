        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
			...
			<div class="border-head">
              <h3>My Patients Records</h3>
            </div>
			 <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
                    Add New Patients
                </button><br><br>
			<?php
		  $res=mysqli_query($link,"SELECT entitydetails.name,entitydetails.email,entitydetails.contact,patient.date, entitydetails.address from entitydetails join patient on entitydetails.edid=patient.edidpatient where patient.ediddoctor=$edid");
		  ...
		  {
	      echo "<tr>";
		  //echo "<td>";echo $row["edidpatient"];echo "</td>";
