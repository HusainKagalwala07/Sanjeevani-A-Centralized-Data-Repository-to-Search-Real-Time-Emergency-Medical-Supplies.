                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card text-white bg-primary o-hidden h-100">
                        <div class="card-body">
                            ...
                            <div class="mr-5">Add New Products</div>
                        </div>
                        <a class="card-footer text-white clearfix small z-1" href="addnewproduct.php">
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card text-white bg-warning o-hidden h-100">
                        <div class="card-body">
                            ...
                            <div class="mr-5">Update Products</div>
                        </div>
                        <a class="card-footer text-white clearfix small z-1" href="updateproduct.php">
                            <span class="float-left">View Details</span>
                            <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
                ...
                <div class="col-xl-3 col-sm-6 mb-3">
                    <div class="card text-white bg-success o-hidden h-100">
                        <div class="card-body">
                            ...
                            <div class="mr-5">Inventory Summary</div>
                        </div>
                        <a class="card-footer text-white clearfix small z-1" href="summaryproduct.php">
                            <span class="float-left">View Details</span>
                            <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
