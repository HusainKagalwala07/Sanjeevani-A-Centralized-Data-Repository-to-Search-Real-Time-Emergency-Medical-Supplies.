...
<div id="wrapper">
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post">
                                <?php
                                //echo "Product Name";
                                $addnewproduct = mysqli_query($link,"select * from products where products.prod_id in (select stock.prod_id from stock where stock.phar_id = '$edid')");
                        ...
                        {
                            ?>
                            <script>var e = document.getElementById("newproductlist");
                                var strUser = e.options[e.selectedIndex].value;

                            </script>
                            <?php
                            $prod_id = $_POST['newproductlist'];
                            $qty = htmlentities($_POST['quantity']);
                            mysqli_query($link,"update stock set stock.quantity = $qty where stock.phar_id = $edid and stock.prod_id = '$prod_id'");
                            ?>
                            <br>
                            <div class=" col-lg-12 col-lg-push-3 alert alert-success"><b>Updated Successfully!</b></div>
                            <?php
                        }
                        ?>
            ...
            $result1=mysqli_query($link,"select * from stock where stock.phar_id = $edid");
